...
?>
<div class="container-fluid" style="margin-left: 1%; width:98%; height: 500px; background-color:white; height: 110px;">
    ...
    <div class="row" style="position:relative; top:-50px;">
        <div class="col-2" style="background-coor:red;height:40px; margin-left:3%; text-align:center;">
            <p class="menu"><a style="text-decoration:none ;position:relative; top:2.5px; color:white;" href="index.php?lien=accueil&link=1&numPage=1">Liste des questions</a></p>
        </div>
        <div class="col-2" style="background-coor:red;height:40px; margin-left:3%;text-align:center;">
